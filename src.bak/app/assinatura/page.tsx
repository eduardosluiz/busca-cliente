    ...
    <div className="flex h-screen bg-white">
      ...
      <aside className="w-64 bg-white border-r border-gray-200">
        ...
        <nav className="p-4">
          <ul className="space-y-2">
            ...
            <li>
              <a href="/assinatura" className="flex items-center space-x-3 p-2 rounded-lg bg-gradient-to-r from-blue-600 to-cyan-500 text-white">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
              <a href="/configuracoes" className="flex items-center space-x-3 p-2 rounded-lg hover:bg-gradient-to-r hover:from-blue-50 hover:to-cyan-50 text-gray-600 hover:text-blue-600">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="flex-1 overflow-y-auto bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <p className="mt-2 text-gray-600">Visualize e altere seu plano atual de acordo com suas necessidades</p>
          ...
          <div className="mt-8">
            <div className="flex items-center space-x-2 text-gray-900 mb-4">
              ...
              <h2 className="text-lg font-semibold">Sua assinatura atual</h2>
            </div>
