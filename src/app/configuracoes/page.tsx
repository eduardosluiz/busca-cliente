    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <aside className="w-64 bg-[#1E2A4A] text-white">
        <div className="p-4 border-b border-gray-700 flex items-center justify-center">
          <Image 
            src="https://raw.githubusercontent.com/dude-IA/busca-cliente/main/public/logo.png"
            alt="Busca Cliente.ia"
            width={140}
            height={30}
            priority
        ...
        <nav className="p-4">
          <ul className="space-y-2">
            ...
            <li>
              <a href="/configuracoes" className="flex items-center space-x-3 p-2 rounded-lg bg-blue-600/20">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
