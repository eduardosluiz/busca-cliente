...
export default function Home() {
  ...
  const openRegisterModal = (plan?: string) => {
                  ...
                  >
                    {plan.popular && (
                      <div className="absolute top-0 right-0 transform translate-x-2 -translate-y-2">
                        <span className="bg-gradient-to-r from-blue-600 to-cyan-500 text-white px-3 py-1 rounded-full text-sm">
                          Mais Popular
                        </span>
                      </div>
                    )}
                    ...
                    <button
                      onClick={() => openRegisterModal(plan.plan)}
                      className={`block w-full text-center py-3 rounded-lg font-semibold transition-all duration-200 ${
                        plan.popular
                          ? 'bg-gradient-to-r from-blue-600 to-cyan-500 text-white hover:from-blue-700 hover:to-cyan-600 transform hover:scale-105 hover:shadow-lg'
